...
export default function ContainerCard({ ct, onAction, onConsole }) {
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ color: "rgba(255,255,255,0.35)", fontSize: 11, fontFamily: "'JetBrains Mono', monospace" }}>CT {ct.id}</div>
          </div>
        </div>
        <div style={{
          background: statusBg(ct.status),
